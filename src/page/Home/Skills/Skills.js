...
import skillsSvg from '../../../images/svg/skills.svg';
import './Skills.css'
        ...
        >
            ...
            <div className="row">
                ...
                >
                    ...
                    <div className="row mt-2">
                        <b>JavaScript <span className="text-info">90%</span></b>
                        <div className='w-100 bg-secondary rounded-pill p-1'>
                            <div style={{ width: '90%', height: '3px', margin: '1px' }} className="skill-mouseOver rounded-pill ps-1 fw-bold text-dark">
                            </div>
                        </div>
                    ...
                    <div className="row mt-2">
                        <b>React Js <span className="text-info">85%</span></b>
                        <div className='w-100 bg-secondary rounded-pill p-1'>
                    ...
                    <div className="row mt-2">
                        <b>React Router v5 + v6 <span className="text-info">95%</span></b>
                        <div className='w-100 bg-secondary rounded-pill p-1'>
                            <div style={{ width: '95%', height: '3px', margin: '1px' }} className="skill-mouseOver rounded-pill ps-1 fw-bold text-dark">
                            </div>
                        </div>
                    ...
                    <div className="row mt-2">
                        <b>Firebase <span className="text-info">80%</span></b>
                        <div className='w-100 bg-secondary rounded-pill p-1'>
                            <div style={{ width: '80%', height: '3px', margin: '1px' }} className="skill-mouseOver rounded-pill ps-1 fw-bold text-dark">
                            </div>
                        </div>
                    ...
                    <div className="row mt-2">
                        <b>Material Ui <span className="text-info">90%</span></b>
                        <div className='w-100 bg-secondary rounded-pill p-1'>
                            <div style={{ width: '90%', height: '3px', margin: '1px' }} className="skill-mouseOver rounded-pill ps-1 fw-bold text-dark">
                            </div>
                        </div>
                    ...
                    <div className="row mt-2">
                        <b>Tailwind CSS <span className="text-info">80%</span></b>
                        <div className='w-100 bg-secondary rounded-pill p-1'>
                            <div style={{ width: '80%', height: '3px', margin: '1px' }} className="skill-mouseOver rounded-pill ps-1 fw-bold text-dark">
                            </div>
                        </div>
                ...
                <div className="mt-5">
                    ...
                    <h5>API, Github, React Redux, React Form, Axios, Animate.css, AOS, SASS, Styled-components, Font Awesome</h5>
                </div>
            </div>
        </div>
    );
